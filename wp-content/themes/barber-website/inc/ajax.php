...
function barber_save_contact(){
	...
	//TO TEST if the contact form works need to go to https://mailtrap.io/ . Function mailtrap($phpmailer) is in theme-support.php !!!!!
	if($postID !== 0){//Doesn't work on localhost. Need to be uploaded to live host to test the code.
		...
		$subject = 'Barber Contact Form - ' . $title;
	...
	//echo 0; to test if works contact form in barber-portfolio.js ajax section success
