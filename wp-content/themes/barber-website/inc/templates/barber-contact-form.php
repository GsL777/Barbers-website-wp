...
<form method="post" action="options.php" class="barber-general-form">
	...
	<?php settings_fields( 'barber-contact-options' ); //Contact Form Options from function barber_custom_settings register_setting First parameter?>
	
	<?php do_settings_sections( 'barber_website_theme_contact' ); //Contact Form Options from function barber_custom_settings Fourth parameter?>
